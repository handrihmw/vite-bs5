<template>
  <div>
    <div class="row align-items-center">
      <AsAccordion>
        <AsAccordionTitle withLabel textLabel="label 1">
          <h3 class="as-text-16">Accordion Title 1</h3>
        </AsAccordionTitle>
        <AsAccordionContent>
          <p class="as-text-14 as-color-secondary-2">
      ...
      <AsAccordion>
        <AsAccordionTitle withLabel textLabel="label 2">
          <h3 class="as-text-16">Accordion Title 2</h3>
        </AsAccordionTitle>
        <AsAccordionContent>
          <p class="as-text-14 as-color-secondary-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime
      ...
      <AsAccordion>
        <AsAccordionTitle withLabel textLabel="label 3">
          <h3 class="as-text-16">Accordion Title 3</h3>
        </AsAccordionTitle>
        <AsAccordionContent>
          <p class="as-text-14 as-color-secondary-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime
